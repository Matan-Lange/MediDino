...
def parse_parameters():
    ...
    group.add_argument('--dino_version', type=str, help='Version of Dino to use')
    group.add_argument('--ssl_model_path', type=str, help='Path to the custom_SSL_DINO model')
...
if __name__ == "__main__":
    ...
    for i in range(1, 6):
        ...
        if params.ssl_model_path:
            model = DinoVisionTransformerClassifier(ssl_dino_path=params.ssl_model_path)
        else:
